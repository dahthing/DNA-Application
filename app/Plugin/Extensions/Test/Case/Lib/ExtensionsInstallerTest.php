 ...
 */
class ExtensionsInstallerTest extends DnaTestCase {
 ...
 */
	public function testComposerInstall() {
		...
		$prop = $ExtensionsInstaller->getProperty('_DnaComposer');
		$prop->setAccessible(true);
		$ExtensionsInstallerMock = new ExtensionsInstaller();

		$DnaComposer = $this->getMock('DnaComposer', array(
			'getComposer', 'setConfig', 'runComposer',
		));
		$prop->setValue($ExtensionsInstallerMock, $DnaComposer);
