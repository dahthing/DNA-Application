...
class NodeFixture extends DnaTestFixture {
	...
	public $records = array(
		array(
			...
			'title' => 'Hello World',
			'slug' => 'hello-world',
			'body' => '<p>Welcome to Dna. This is your first post. You can edit or delete it from the admin panel.</p>',
			'excerpt' => '',
			'status' => 1,
			'mime_type' => '',
			'comment_status' => 2,
		...
		array(
			...
			'title' => 'About',
			'slug' => 'about',
			'body' => '<p>This is an example of a Dna page, you could edit this to put information about yourself or your site.</p>',
			'excerpt' => '',
			'status' => 1,
			'mime_type' => '',
			'comment_status' => 0,
