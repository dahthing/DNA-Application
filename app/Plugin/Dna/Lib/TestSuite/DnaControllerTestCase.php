 ...
 */
class DnaControllerTestCase extends ControllerTestCase {
	...
	protected static function _restoreSettings() {
		$configDir = CakePlugin::path('Dna') . 'Test' . DS . 'test_app' . DS . 'Config' . DS;
 ...
 */
	public function setUp() {
		...
		$appDir = CakePlugin::path('Dna') . 'Test' . DS . 'test_app' . DS;
		...
		Configure::config('settings', new DnaJsonReader(dirname($Setting->settingsPath) . DS ));
		CakeLog::drop('stdout');
		CakeLog::drop('stderr');
