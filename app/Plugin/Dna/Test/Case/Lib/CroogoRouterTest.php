...
App::uses('DnaRouter', 'Dna.Lib');

class DnaRouterTest extends DnaTestCase {
 ...
 */
	public function testHomeRoute() {
		...
		$result = DnaRouter::connect('/', $promoted);
		...
		$result = DnaRouter::connect('/nodes', $index);
		...
		$result = DnaRouter::connect('/', $terms);
