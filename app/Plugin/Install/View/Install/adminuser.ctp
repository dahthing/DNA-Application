...
?>
<div class="install">
	<h2><?php echo __d('dna', 'Step 3: Create Admin User'); ?></h2>
	<?php
		...
		echo $this->Form->input('User.password', array(
			'placeholder' => __d('dna', 'New Password'),
			'value' => '',
		...
		echo $this->Form->input('User.verify_password', array(
			'placeholder' => __d('dna', 'Verify Password'),
			'type' => 'password',
			'value' => '',
			'before' => '<span class="add-on"><i class="icon-key"></i></span>',
			'div' => 'input password input-prepend',
...
<div class="form-actions">
	<?php echo $this->Form->submit(__d('dna', 'Save'), array('class' => 'btn btn-success', 'div' => false)); ?>
	<?php echo $this->Html->link(__d('dna', 'Cancel'), array('action' => 'index'), array( 'class' => 'btn cancel')); ?>
</div>
<?php
	echo $this->Form->end();
?>