 ...
 * Meta Component
 *
 * @package Dna.Meta.Controller.Component
 */
 ...
 */
	protected function _adminTabs() {
		...
		$title = __d('dna', 'Custom Fields');
		$element = 'Meta.admin/meta_tab';
		Dna::hookAdminBox("$controller/admin_add", $title, $element);
		Dna::hookAdminBox("$controller/admin_edit", $title, $element);
	}
