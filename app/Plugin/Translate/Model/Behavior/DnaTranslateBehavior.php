 ...
 *
 * @category Behavior
 * @package  Dna.Translate.Model.Behavior
 * @version  1.0
 * @author   Fahad Ibnay Heylaal <contact@fahad19.com>
 * @license  http://www.opensource.org/licenses/mit-license.php The MIT License
 * @link     http://www.dna.org
 */
class DnaTranslateBehavior extends ModelBehavior {
 ...
 * Callback
 *
 * $config for DnaTranslateBehavior should be
 ...
 */
	public function setup(Model $model, $config = array()) {
		...
		if (!$db->connected) {
			trigger_error(
				__d('dna', 'Datasource %s for DnaTranslateBehavior of model %s is not connected', $model->useDbConfig, $model->alias),
				E_USER_ERROR
			);
			return false;
		}
