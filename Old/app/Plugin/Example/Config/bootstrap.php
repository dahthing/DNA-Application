 ...
 */
Dna::hookBehavior('Node', 'Example.Example', array());
 ...
 */
Dna::hookComponent('*', 'Example.Example');
 ...
 */
Dna::hookHelper('Nodes', 'Example.Example');

/**
 * Admin menu (navigation)
 */
DnaNav::add('extensions.children.example', array(
	'title' => 'Example',
	'url' => '#',
	'children' => array(
		'example1' => array(
 ...
 */
Dna::hookAdminRowAction('Nodes/admin_index', 'Example', 'plugin:example/controller:example/action:index/:id');

/* Row action with link options */
Dna::hookAdminRowAction('Nodes/admin_index', 'Button with Icon', array(
...
Dna::hookAdminRowAction('Nodes/admin_index', 'Icon Only', array(
	'plugin:example/controller:example/action:index/:id' => array(
		'title' => false,
		'options' => array(
			'icon' => 'picture',
 ...
 */
Dna::hookAdminTab('Nodes/admin_add', 'Example', 'example.admin_tab_node');
Dna::hookAdminTab('Nodes/admin_edit', 'Example', 'example.admin_tab_node');
