 ...
 */
	public function onActivation(&$controller) {
		...
		$controller->Dna->addAco('Example/Example/admin_index'); // ExampleController::admin_index()
		$controller->Dna->addAco('Example/Example/index', array('registered', 'public')); // ExampleController::index()
 ...
 */
	public function onDeactivation(&$controller) {
		...
		$controller->Dna->removeAco('Example'); // ExampleController ACO and it's actions will be removed
