 ...
 */
	protected function _adminMenu() {
		...
		foreach ($types as $t) {
			DnaNav::add('content.children.create.children.' . $t['Type']['alias'], array(
				'title' => $t['Type']['title'],
				'url' => array(
					'plugin' => 'nodes',
					'admin' => true,
		...
		foreach ($vocabularies as $v) {
			...
			DnaNav::add('content.children.taxonomy.children.' . $v['Vocabulary']['alias'], array(
