        ...
        <table class="table table-striped">
            ...
            foreach ($menus as $menu):
                ...
                $actions[] = $this->Dna->adminRowAction(
                        '', array('controller' => 'links', 'action' => 'index', '?' => array('menu_id' => $menu['Menu']['id'])), array('icon' => 'zoom-in', 'tooltip' => __d('dna', 'View links'))
                );
                $actions[] = $this->Dna->adminRowActions($menu['Menu']['id']);
                $actions[] = $this->Dna->adminRowAction(
                        '', array('controller' => 'menus', 'action' => 'edit', $menu['Menu']['id']), array('icon' => 'pencil', 'tooltip' => __d('dna', 'Edit this item'))
                );
                $actions[] = $this->Dna->adminRowAction(
                        '', array('controller' => 'menus', 'action' => 'delete', $menu['Menu']['id']), array('icon' => 'trash', 'tooltip' => __d('dna', 'Remove this item')), __d('dna', 'Are you sure?')
                );
