<?php
App::uses('LayoutHelper', 'Dna.View/Helper');
...
class LayoutHelperTest extends DnaTestCase {
 ...
 */
	public function setUp() {
		...
		$this->Html = new DnaHtmlHelper($view);
 ...
 */
	public function testJs() {
		$this->assertContains('var Dna = {"basePath":"\/","params":{"plugin":null,"controller":"nodes","action":"index","named":[]}};', $f = $this->Layout->js());

		$this->Layout->params['locale'] = 'eng';
		$this->assertContains('var Dna = {"basePath":"\/eng\/","params":{"plugin":null,"controller":"nodes","action":"index","named":[]}};', $this->Layout->js());
		unset($this->Layout->params['locale']);

		Configure::write('Js.my_var', '123');
		$this->assertContains('var Dna = {"basePath":"\/","params":{"plugin":null,"controller":"nodes","action":"index","named":[]},"my_var":"123"};', $this->Layout->js());

		Configure::write('Js.my_var2', '456');
		$this->assertContains('var Dna = {"basePath":"\/","params":{"plugin":null,"controller":"nodes","action":"index","named":[]},"my_var":"123","my_var2":"456"};', $this->Layout->js());
	}
