 ...
 * @access public
 */
	public $helpers = array('FileManager.FileManager', 'Text', 'Dna.Image');
 ...
 */
	public function admin_index() {
		$this->set('title_for_layout', __d('dna', 'Attachments'));
 ...
 */
	public function admin_add() {
		$this->set('title_for_layout', __d('dna', 'Add Attachment'));
		...
		if ($this->request->is('post') || !empty($this->request->data)) {
			...
			if (empty($this->data['Attachment'])) {
				$this->Attachment->invalidate('file', __d('dna', 'Upload failed. Please ensure size does not exceed the server limit.'));
				return;
			}
			...
			if ($this->Attachment->save($this->request->data)) {
				...
				$this->Session->setFlash(__d('dna', 'The Attachment has been saved'), 'default', array('class' => 'success'));
				...
				$this->Session->setFlash(__d('dna', 'The Attachment could not be saved. Please, try again.'), 'default', array('class' => 'error'));
			}
		}
	}
 ...
 */
	public function admin_edit($id = null) {
		$this->set('title_for_layout', __d('dna', 'Edit Attachment'));
		...
		if (!$id && empty($this->request->data)) {
			$this->Session->setFlash(__d('dna', 'Invalid Attachment'), 'default', array('class' => 'error'));
			$this->redirect(array('action' => 'index'));
		}
 ...
 */
	public function admin_delete($id = null) {
		if (!$id) {
			$this->Session->setFlash(__d('dna', 'Invalid id for Attachment'), 'default', array('class' => 'error'));
			$this->redirect(array('action' => 'index'));
		}

		if ($this->Attachment->delete($id)) {
			$this->Session->setFlash(__d('dna', 'Attachment deleted'), 'default', array('class' => 'success'));
			$this->redirect(array('action' => 'index'));
		} else {
			$this->Session->setFlash(__d('dna', 'Invalid id for Attachment'), 'default', array('class' => 'error'));
			$this->redirect(array('action' => 'index'));
