...
class Install extends InstallAppModel {
    ...
    public function runMigrations($plugin) {
        ...
        return $this->_getDnaPlugin()->migrate($plugin);
    }

    protected function _getDnaPlugin() {
        if (!($this->_DnaPlugin instanceof DnaPlugin)) {
            $this->_setDnaPlugin(new DnaPlugin());
        }
        return $this->_DnaPlugin;
    }

    protected function _setDnaPlugin($dnaPlugin) {
        unset($this->_DnaPlugin);
        $this->_DnaPlugin = $dnaPlugin;
    }
